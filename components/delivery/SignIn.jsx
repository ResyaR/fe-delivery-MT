...
export default function SignIn() {
  ...
  return (
    <div className="bg-white">
      ...
      <div className="flex items-start self-stretch bg-white pl-[80px] sm:pl-[120px] md:pl-[159px] rounded-3xl">
        <div className="flex flex-col shrink-0 items-start mt-[80px] sm:mt-[120px] md:mt-[149px] mr-8 sm:mr-20 md:mr-40">
          ...
          <div className="flex flex-col items-start relative py-[5px] px-[60px] sm:px-[100px] md:px-[113px] mb-6">
            <span className="text-[#1C1C1C] text-sm sm:text-base">
              Login with Others
            </span>
            <img
        ...
        <div className="flex-1 items-start relative hidden lg:block">
          ...
          <div className="flex flex-col items-start bg-[url('https://storage.googleapis.com/tagjs-prod.appspot.com/v1/pmhU3FeeUc/fgos3yip_expires_30_days.png')] bg-cover bg-center w-[500px] sm:w-[600px] md:w-[785px] absolute bottom-24 right-[19px] rounded-3xl">
